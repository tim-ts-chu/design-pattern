...
class GumballMachine:
    def __init__(self):
        ...
        self._num_of_gaumball = 0

    def set_candy_amount(self, num_of_gaumball):
    ...
    def insert_quarter(self):
        ...
        return 'insert quarter was executed'

    def eject_quarter(self):
        self._state.eject_quarter()
        return 'eject quarter was executed'

    def turn_crank(self):
        self._state.turn_crank()
        return 'turn quarter was executed'

    def dispense(self):
        self._state.dispense()
        return 'dispense quarter was executed'
